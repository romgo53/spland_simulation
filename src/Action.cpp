...
ActionStatus BaseAction::getStatus() const { return ActionStatus::ERROR; } // Placeholder
...
const string SimulateStep::toString() const { return ""; } // Placeholder
...
const string AddPlan::toString() const { return ""; } // Placeholder
...
const string AddSettlement::toString() const { return ""; } // Placeholder
...
const string AddFacility::toString() const { return ""; } // Placeholder

// PrintPlanStatus
PrintPlanStatus::PrintPlanStatus(int planId) : planId(planId) {}
void PrintPlanStatus::act(Simulation &simulation) {}
PrintPlanStatus* PrintPlanStatus::clone() const { return new PrintPlanStatus(*this); }
const string PrintPlanStatus::toString() const { return ""; } // Placeholder
...
const string ChangePlanPolicy::toString() const { return ""; } // Placeholder

// PrintActionsLog
PrintActionsLog::PrintActionsLog() {}
void PrintActionsLog::act(Simulation &simulation) {}
PrintActionsLog* PrintActionsLog::clone() const { return new PrintActionsLog(*this); }
const string PrintActionsLog::toString() const { return ""; } // Placeholder

// Close
Close::Close() {}
void Close::act(Simulation &simulation) {}
Close* Close::clone() const { return new Close(*this); }
const string Close::toString() const { return ""; } // Placeholder

// BackupSimulation
BackupSimulation::BackupSimulation() {}
void BackupSimulation::act(Simulation &simulation) {}
BackupSimulation* BackupSimulation::clone() const { return new BackupSimulation(*this); }
const string BackupSimulation::toString() const { return ""; } // Placeholder

// RestoreSimulation
RestoreSimulation::RestoreSimulation() {}
void RestoreSimulation::act(Simulation &simulation) {}
RestoreSimulation* RestoreSimulation::clone() const { return new RestoreSimulation(*this); }
const string RestoreSimulation::toString() const { return ""; } // Placeholder
